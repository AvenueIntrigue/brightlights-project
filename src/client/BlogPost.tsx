...
const BlogPost = () => {
  ...
  const handleShareOnX = () => {
    ...
    var xUrl = 'https://www.x.com/intent/tweet?url=' + encodeURIComponent(currentUrl);
...
const handleShareViaEmail = () => {
  ...
  var emailBody = encodeURIComponent('I thought you might find this interesting: ' + currentUrl);
  var mailtoLink = 'mailto:?subject=' + emailSubject + '&body=' + emailBody + '%0D%0A' + '%0D%0A' + currentUrl;
  ...
  <button type='button' onClick={toggleShare} className='icon-button'>
    <Share className='mx-auto h-10 w-10'/>
  </button>

  {isShareVisible && (
    <div className=''>
      <button type='button' className='icon-button' onClick={handleShareOnX}>
      <XIcon />
      </button>
      <button type='button' className='icon-button' onClick={handleShareOnFacebook}>
        <FaceBookIcon />
      </button>
      <button type='button' className='icon-button' onClick={handleShareViaEmail}>
        <EmailIcon />
      </button>
      <CopyLinkButton/>
