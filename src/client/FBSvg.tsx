...
const FBSvg: React.FC = () => {
  const [svgContent, setSvgContent] = useState<string | null>(null);
  const cloudinaryFBUrl = "https://res.cloudinary.com/dqltncrkn/image/upload/v1743302326/Facebook-Logo_ef4qml.svg";

  useEffect(() => {
    const fetchSvg = async () => {
      try {
        const response = await axios.get(cloudinaryFBUrl, {
