...
const GitHubSvg: React.FC = () => {
  ...
  const cloudinaryGitHubUrl = "https://res.cloudinary.com/dqltncrkn/image/upload/v1743302327/GitHub_ohwmqz.svg";

  useEffect(() => {
    const fetchSvg = async () => {
      try {
        const response = await axios.get(cloudinaryGitHubUrl, {
