            ...
            />
                ...
                <div className="blogcard-title">
                  <h2 dangerouslySetInnerHTML={{__html: sanitizedTitle}}/>
                    ...
                    <h4 className="description" dangerouslySetInnerHTML={{ __html: sanitizedDescription }}/>
          </div>
          <div className="blogcard-button-container">
                    <button type="submit" className="blogcard-button" onClick={handleReadMore}><BookOpenText className="icon"/><span className="button-text">Read More</span></button>
                    </div> 
                    </div>
                    </div>
                    <hr className="line"/>
